 ...
 */
export type IncludeShippingPickupDefault = Array<'cart.lineItems.physicalItems.options' | 'cart.lineItems.digitalItems.options' | 'cart.lineItems.physicalItems.categoryNames' | 'cart.lineItems.digitalItems.categoryNames' | 'cart.lineItems.customItems.categoryNames' | 'customer' | 'customer.customerGroup' | 'payments' | 'promotions' | 'consignments.availableShippingOptions' | 'consignments.availablePickupOptions'>;
